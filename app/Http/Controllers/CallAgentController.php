...
class CallAgentController extends Controller
{
    function AddTheAgent(Request $request) {
        ...
        CURLOPT_URL => request()->getSchemeAndHttpHost().'/api/AgentRegister',
    ...
    function UpdateTheAgent(Request $request) {
        $curl = curl_init();
        curl_setopt_array($curl, array(
        CURLOPT_URL => request()->getSchemeAndHttpHost().'/api/AdminUpdateAgentProfile/'. $request->no_anggota,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
    ...
    function DeleteTheAgent(Request $request, $agent) {
        $curl = curl_init();
        curl_setopt_array($curl, array(
        CURLOPT_URL => request()->getSchemeAndHttpHost().'/api/DeleteAgent/'. $agent,
        CURLOPT_RETURNTRANSFER => true,
        CURLOPT_ENCODING => '',
        CURLOPT_MAXREDIRS => 10,
        CURLOPT_TIMEOUT => 0,
